    ...
    <nav class="bg-white border-b border-gray-200 px-4 py-2.5 fixed left-0 right-0 top-0 z-40">
        <div class="flex flex-wrap justify-between items-center">
            <div class="flex justify-start items-center">
                <button type="button" @click="emit('drawer-clicked')" data-drawer-target="drawer-navigation"
            ...
            <div class="flex items-center sm:order-2">
                ...
                <div class="hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg rounded-xl"
                    ...
                    <div class="block py-2 px-4 text-base font-semibold text-center text-gray-700 bg-gray-50">
                        Notifications
                    </div>
                    <div>
                        ...
                        <a href="#" class="flex py-3 px-4 border-b hover:bg-gray-100">
                            ...
                            <div class="pl-3 w-full">
                                <div class="text-gray-500 font-normal text-sm mb-1.5">
                                    ...
                                    and
                                    <span class="font-semibold text-gray-900">5 others</span>
                        ...
                        <a href="#" class="flex py-3 px-4 border-b hover:bg-gray-100">
                            ...
                            <div class="pl-3 w-full">
                                <div class="text-gray-500 font-normal text-sm mb-1.5">
                                    ...
                                    and
                                    <span class="font-semibold text-gray-900">141 others</span>
                        ...
                        <a href="#" class="flex py-3 px-4 border-b hover:bg-gray-100">
                            ...
                            <div class="pl-3 w-full">
                                <div class="text-gray-500 font-normal text-sm mb-1.5">
                                    ...
                                    <span class="font-semibold text-blue-600">@bonnie.green</span>
                                    what do you say?
                                </div>
                                <div class="text-xs font-semibold text-blue-600">
                                    1 hour ago
                    ...
                    <a href="#"
                        class="block py-2 text-md font-semibold text-center text-gray-900 bg-gray-50 hover:bg-gray-100">
...
<script setup>
const emit = defineEmits(['drawer-clicked']);
</script>